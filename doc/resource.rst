...
```
http://<ngw url>/api/resource/{id}/feature/{fid} - один объект
http://<ngw url>/api/resource/{id}/feature/      - все объекты векторного слоя
```
Запрос: 

```json
http://demo.nextgis.ru/ngw/api/resource/1878/feature/8
```
