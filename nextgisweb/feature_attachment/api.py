...
from nextgisweb.feature_layer import IVersionableFeatureLayer
...
def download(
    ...
    *,
    ...
    fname = env.file_storage.filename(fobj)
    response = UnsafeFileResponse(fname, content_type=mime_type, request=request)
