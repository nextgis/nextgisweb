...
CREATE TABLE feature_description_et(
    ...
    CONSTRAINT feature_description_et_ctab_fkey FOREIGN KEY (resource_id, feature_id) REFERENCES feature_description(resource_id, feature_id) DEFERRABLE INITIALLY DEFERRED,
...
CREATE INDEX feature_description_et_version_id_idx ON public.feature_description_et USING btree (resource_id, version_id) INCLUDE (feature_id);
