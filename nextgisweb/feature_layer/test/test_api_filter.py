...
def test_filter_all_single_condition(ngw_webtest_app, test_layer_id):
    ...
    resp = ngw_webtest_app.get(
        f"/api/resource/{test_layer_id}/feature/", {"filter_expression": filter_expr}, status=200
    )
...
def test_filter_invalid_format(ngw_webtest_app, test_layer_id):
    ...
    ngw_webtest_app.get(
        f"/api/resource/{test_layer_id}/feature/", {"filter_expression": filter_expr}, status=422
    )
...
def test_filter_with_pagination(ngw_webtest_app, test_layer_id):
    ...
    resp = ngw_webtest_app.get(
        ...
        {"filter_expression": filter_expr, "limit": 2, "offset": 0},
        status=200,
    )
    assert len(resp.json) == 2
    ...
    resp = ngw_webtest_app.get(
        f"/api/resource/{test_layer_id}/feature/",
        {"filter_expression": filter_expr, "limit": 2, "offset": 2},
        status=200,
    )
    assert len(resp.json) == 1
...
def test_filter_with_ordering(ngw_webtest_app, test_layer_id):
    ...
    resp = ngw_webtest_app.get(
        f"/api/resource/{test_layer_id}/feature/",
        {"filter_expression": filter_expr, "order_by": "-age"},
        status=200,
    )
