...
class FeatureUpdate(Struct, kw_only=True, tag="feature.update", tag_field="action"):
    """Update feature geometry and fields by ID"""
...
class FeatureLayerExecutor(OperationExecutor):
    def prepare(self, operation: Union[FeatureCreate, FeatureUpdate, FeatureDelete]):
    ...
    def execute(self, operation):
        ...
        if isinstance(operation, (FeatureCreate, FeatureUpdate)):
