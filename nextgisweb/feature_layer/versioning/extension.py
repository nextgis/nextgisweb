...
from typing import Any, ClassVar, Dict, Literal, NamedTuple, Optional, Tuple, Type, Union
...
class FVersioningExtensionMixin:
    ...
    fversioning_columns: ClassVar[Tuple[str, ...]]
    fversioning_htab_args: ClassVar[Tuple[Any, ...]] = tuple()
