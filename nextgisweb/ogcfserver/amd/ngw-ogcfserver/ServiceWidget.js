define([
    ...
    return declare([ContentPane, serialize.Mixin, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        serializeInMixin: function (data) {
            if (data.ogcfserver_service === undefined) { data.ogcfserver_service = {}; }
            ...
            data.ogcfserver_service.collections = array.map(store.getValues(this.itemModel.root, "children"), function (i) {
                return dump(i); });
        },
