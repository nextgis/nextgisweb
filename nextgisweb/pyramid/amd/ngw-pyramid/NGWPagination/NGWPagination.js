define([
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        constructor: function (options) {
            ...
            this.withPrev =
                this.prevQuery && typeof this.prevQuery === "object";
            this.withNext =
                this.nextQuery && typeof this.nextQuery === "object";
        },
                ...
                on(
                    ...
                    lang.hitch(this, function () {
                        window.location.href =
                            this.action + "?" + this._getQuery(this.prevQuery);
                    })
                );
            }
            if (this.nextButton) {
                on(
                    ...
                    lang.hitch(this, function () {
                        window.location.href =
                            this.action + "?" + this._getQuery(this.nextQuery);
                    })
                );
            }
        },
