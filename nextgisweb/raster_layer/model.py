...
class RasterLayer(Resource, SpatialLayerMixin):
    ...
    storage_id: Mapped[int | None] = mapped_column(
        # NOTE: Autogenerated name conflicts with `raster_layer_storage.id`! Pin it explicitly.
        sa.ForeignKey(RasterLayerStorage.id, name="raster_layer_storage_id_fkey1")
    )
