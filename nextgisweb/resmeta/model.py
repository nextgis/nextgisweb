...
class ResourceMetadataSerializer(Serializer):
    ...
    # TODO: It would be possible nice to implement serialization without
    # intermediate items key, but this is impossible right now as serialization
    # as a whole and serialization of attributes are mixed in one class.
