...
def setup_pyramid(comp, config):
    ...
    def _route(route_name, route_path, **kwargs):
        return config.add_route("resource." + route_name, "/resource/" + route_path, **kwargs)

    def _resource_route(route_name, route_path, **kwargs):
        return _route(route_name, route_path, factory=resource_factory, **kwargs)
    ...
    _resource_route("json", r"{id:uint}/json").add_view(json_view)

    _resource_route("effective_permissions", r"{id:uint}/permissions").add_view(
        effective_permisssions
    )
