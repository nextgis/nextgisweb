  ...
  const onChange = useCallback(
    (_: unknown, values: SymbolizerValues) => {
      const symbolizer = {
        ...
        channels: {
          red: {
            source_channel: values.redChannel ? values.redChannel + 1 : 1,
          ...
          green: {
            source_channel: values.greenChannel ? values.greenChannel + 1 : 1,
            contrast_enhancement: {
              normalize: {
                algorithm: "stretch",
          ...
          blue: {
            source_channel: values.blueChannel ? values.blueChannel + 1 : 1,
            contrast_enhancement: {
              normalize: {
                algorithm: "stretch",
