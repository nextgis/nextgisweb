...
> {
  ...
  get isValid() {
    ...
    if (this.mode === "file") {
      return !this.uploading && !!this.source && this.sourceLayer !== null;
    }
    if (this.mode === "copy") {
  ...
  get confirmMsg() {
    ...
    if (mode === "delete" || (mode === "file" && this.sourceLayer !== null)) {
      return gettext("Confirm deletion of existing features");
    }

    if (mode === "gtype" && this.geometryType !== this.geometryTypeInitial) {
