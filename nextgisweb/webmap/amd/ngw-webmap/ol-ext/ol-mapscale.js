define(["dojo/topic", "openlayers/ol"], function (topic, ol) {
    /**
    ...
    var MapScaleControl = (function (_Control) {
        ...
        function MapScaleControl() {
            ...
            var scaleLineClassName =
                options.scaleLineClassName || "ol-scale-line";
            var scaleValueClassName =
                options.scaleLineClassName || "ol-scale-value";
            ...
            var _this = possibleConstructorReturn(
                this,
                (
                    MapScaleControl.__proto__ ||
                    Object.getPrototypeOf(MapScaleControl)
                ).call(this, {
                    element: element,
                    render: render,
                    target: target,
             ...
             * @private
             */
            _this.scaleValueElement_ = createElement(
                "div",
                scaleValueClassName
            );
            ...
            if (typeof options.scaleLine === "undefined" || options.scaleLine) {
                var scaleLineElement = createElement(
                    "div",
                ...
                _this.scaleLine_.on(
                    "change:units",
                    _this.handleUnitsChanged_.bind(_this)
                );
            }
            return _this;
        }
            ...
            [
                {
                    ...
                    value: function setMap(map) {
                        ...
                        get(
                            MapScaleControl.prototype.__proto__ ||
                ...
                },
                {
                    ...
                    value: function updateElement_() {
                        ...
                        if (viewState) {
                            ...
                            this.scaleValueElement_.innerHTML =
                                "1 : " + scaleValue;
                        }
                    },
                },
