define([
    ...
    var Popup = function (options) {
        ...
        this.subcontainer = domConstruct.create(
            "div",
            {
        ...
        this.contentDiv = domConstruct.create(
            "div",
            {
        ...
        // Header
        this.titleBar = domConstruct.create(
            "div",
            {
        ...
        this.titleSpan = domConstruct.create(
            "span",
            {
        ...
        // Connecting arrow
        this._connectorDiv = domConstruct.create(
            "div",
            {
