...
define([
    ...
    declare, _PluginBase, lang, array, Deferred, TabContainer, Menu,
    ...
    return declare([_PluginBase], {
        constructor: function (options) {
            ...
            this.display.watch('item', lang.hitch(this, function (attr, oldVal, newVal) {
                var itemConfig = plugin.display.get('itemConfig');
                this.menuItem.set('disabled', !(itemConfig.type == 'layer' && itemConfig.plugin[plugin.identity]));
            }));
        },
