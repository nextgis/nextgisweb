define([
    "dojo/_base/declare", "dojo/_base/array", "dojo/_base/lang", "dojo/dom-class",
    "dojo/request/xhr", "dojo/Deferred", "dojo/json", "dojo/on", "dijit/form/Select",
    "put-selector/put", "openlayers/ol", "proj4/proj4",
    ...
    declare, array, lang, domClass,
    xhr, Deferred, json, on, Select,
    put, ol, proj4,
    CoordinateConverter,
    api,
    spatialRefSysList,
