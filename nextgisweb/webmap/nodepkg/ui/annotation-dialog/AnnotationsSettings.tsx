...
export function AnnotationsSettings({
  ...
  const handleColorChange = (e: string, key: "colorStroke" | "fillStroke") => {
    handleChange(key, e);
  };
  ...
  return (
    <Form layout="horizontal" size="small" className="annotations-settings">
          ...
          <Row gutter={16}>
            ...
            <Col>
              <ColorPicker
                ...
                onChange={(e) => {
                  handleColorChange(e.toHexString(), "colorStroke");
                }}
              />
            </Col>
          </Row>
      ...
      {showFillFormItem && (
        <Form.Item style={customStyleFormItem} label={gettext("Fill color")}>
          <ColorPicker
            presets={[
              {
                label: gettext("Colors"),
      ...
      {showCircleSizeFormItem && (
        ...
        >
          <InputNumber
            ...
            onChange={(newValue) => handleChange("circleSize", newValue ?? 5)}
          />
        </Form.Item>
      )}
    </Form>
