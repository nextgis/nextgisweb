        ...
        ],
        {
            ...
            postCreate: function () {
                ...
                aspect.after(
                    this.wConnection,
                    "set",
                    lang.hitch(this, function (name, value) {
                        if (name == "value") {
                            this.loadCapCache(value);
                        }
                    }),
                    true
                );
            ...
            loadCapCache: function (connection) {
                ...
                var render = function (capdata) {
                    fmtStore.query().forEach(function (i) {
                        fmtStore.remove(i.id);
                    });
                    ...
                    var table = put(
                        widget.wLayerSelect.containerNode,
                    ...
                    array.forEach(
                        ...
                        function (i) {
                            ...
                            on(
                                node,
                                "click",
                                lang.hitch(widget, widget.toggleLayer, i.id)
                            );
                        },
                        this
                    );
            ...
            serializeInMixin: function (data) {
                ...
                value.wmslayers = this.wWMSLayers
                    .get("value")
                    .split(/,\s*/)
                    .join();
