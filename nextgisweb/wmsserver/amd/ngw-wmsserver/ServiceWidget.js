    ...
    return declare(
        ...
        ],
        {
                        ...
                        this.layerPicker.pick().then(
                            lang.hitch(this, function (itm) {
                                ...
                                if (itm.cls.endsWith("_style")) {
                                    // For resources with the "_style" suffix
                                    // use a parent resource as a naming source.
                    ...
                    function (attr, oldValue, newValue) {
                        if (newValue) {
                            ...
                            widget.wLayerMinScale.set(
                                "value",
                                widget.getItemValue("min_scale_denom")
                            );
                            widget.wLayerMaxScale.set(
                                "value",
                                widget.getItemValue("max_scale_denom")
                            );
            ...
            serializeInMixin: function (data) {
                if (data.wmsserver_service === undefined) {
                    data.wmsserver_service = {};
                }
                ...
                data.wmsserver_service.layers = array.map(
